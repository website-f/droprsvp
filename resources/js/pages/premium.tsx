...
interface Props { price: number; days: number; is_premium: boolean; premium_until: string | null }
...
export default function Premium({ price, days, is_premium, premium_until }: Props) {
                ...
                <div className="overflow-hidden rounded-3xl border border-border bg-card shadow-sm">
                    ...
                    <div className="p-8">
                        ...
                        {is_premium ? (
                            ...
                            <form onSubmit={(e) => {
 e.preventDefault(); form.post('/premium/subscribe'); 
}}>
                                <Button type="submit" size="lg" className="mt-8 w-full" disabled={form.processing}>
